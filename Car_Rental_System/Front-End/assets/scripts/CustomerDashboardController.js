...
function setCarDataToFields(car) {
    ...
    let frontViewImg = frontViewPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Cars\\")[1];
    let FrontViewImgSrc = "assets/savedImages//Cars//" + frontViewImg;

    let backViewPath = car.backView;
    let backViewImg = backViewPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Cars\\")[1];
    let backViewImgSrc = "assets/savedImages//Cars//" + backViewImg;

    let sideViewPath = car.sideView;
    let sideViewImg = sideViewPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Cars\\")[1];
    let sideViewImgSrc = "assets/savedImages///Cars//" + sideViewImg;

    let interiorViewPath = car.internalView;
    let interiorViewImg = interiorViewPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Cars\\")[1];
