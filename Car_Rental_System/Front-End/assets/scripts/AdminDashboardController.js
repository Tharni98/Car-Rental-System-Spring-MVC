...
function searchAndLoadCustomerImgs(id) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            let nicFrontImg = nicFrontPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Customers\\")[1];
            let nicFrontImgSrc = "assets/savedImages//Customers//" + nicFrontImg;
            console.log(nicFrontImgSrc);

            let nicBackPath = customer.nicBackImg;
            let nicBackImg = nicBackPath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Customers\\")[1];
            let nicBackImgSrc = "assets/savedImages//Customers//" + nicBackImg;

            let licencePath = customer.licenceImg;
            let licenceImg = licencePath.split("D:\\2nd-sem\\advance-api-development\\Car-Rental-System\\Car_Rental_System\\Front-End\\savedImages\\Customers\\")[1];
